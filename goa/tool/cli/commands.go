...
type (
	...
	CreateOrJoinClusterCommand struct {
		Payload     string
		ContentType string
		PrettyPrint bool
	}
...
func RegisterCommands(app *cobra.Command, c *client.Client) {
	...
	command = &cobra.Command{
		Use:   "createOrJoin",
		Short: `Create a new Couchbase Cluster`,
	}
	tmp1 := new(CreateOrJoinClusterCommand)
	sub = &cobra.Command{
		Use:   `cluster ["/cluster"]`,
		Short: ``,
		Long: `
...
func (cmd *CreateOrJoinClusterCommand) Run(c *client.Client, args []string) error {
	...
	var payload client.CreateOrJoinClusterPayload
	if cmd.Payload != "" {
	...
	resp, err := c.CreateOrJoinCluster(ctx, path, &payload, cmd.ContentType)
	if err != nil {
